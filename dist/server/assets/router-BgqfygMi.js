  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        heroOutline: "border-2 border-primary-foreground/30 text-primary-foreground bg-transparent hover:bg-primary-foreground/10 text-base font-semibold px-8 py-3 h-auto rounded-xl",
        coral: "bg-miami-coral text-primary-foreground shadow-lg hover:bg-miami-coral/90 text-base font-semibold px-8 py-3 h-auto rounded-xl"
      },
      size: {
...
const translations = {
  es: {
    ...
    footer: {
      description: "Servicio profesional de limpieza y mantenimiento de piscinas en Miami. Tu piscina siempre cristalina, sin preocupaciones.",
    ...
    about: {
      ...
      title2: "agua cristalina",
      p1: "En BlueNova Pools, nos dedicamos al cuidado profesional de piscinas con enfoque en calidad, detalle y confianza. Nuestro equipo de expertos certificados se asegura de que cada piscina brille con agua perfectamente balanceada y limpia.",
      p2: "Servimos a residencias, condominios y propiedades comerciales en todo el área de Miami-Dade. Nuestra misión es simple: que disfrutes tu piscina sin preocupaciones.",
      cta: "Contáctanos",
      values: "Nuestros Valores"
    },
    services: {
      badge: "Servicios",
      title: "Soluciones completas para tu piscina",
      subtitle: "Desde limpieza rutinaria hasta reparaciones complejas, cubrimos todas las necesidades de tu piscina.",
      ctaTitle: "¿No sabes qué servicio necesitas?",
      ctaText: "Contáctanos y te asesoramos sin costo. Evaluamos tu piscina y te damos la mejor solución.",
      ctaButton: "Hablar con un Experto",
      items: [
        {
          icon: "🧹",
          title: "Limpieza Semanal",
          description: "Nuestro equipo visita tu piscina semanalmente para aspirar, cepillar paredes y baldosas, limpiar cestas del skimmer y asegurar que el agua se mantenga cristalina."
        },
        {
          icon: "🧪",
          title: "Balance Químico",
          description: "Realizamos análisis completo del agua: pH, cloro, alcalinidad, ácido cianúrico y más. Ajustamos todo para un balance perfecto y seguro."
        },
        {
          icon: "🔧",
          title: "Reparaciones de Equipos",
          description: "Servicio técnico especializado en bombas, filtros, calentadores, sistemas de sal y automatización. Diagnóstico y reparación rápida."
        },
        {
          icon: "🌿",
          title: "Control de Algas",
          description: "Tratamiento especializado para prevenir y eliminar algas verdes, negras o amarillas. Devolvemos el brillo a tu piscina."
        },
        {
          icon: "🏊",
          title: "Apertura y Cierre",
          description: "Preparamos tu piscina para la temporada o la cerramos correctamente. Cubrimos inspección, limpieza profunda y preparación de equipos."
        },
        {
          icon: "💡",
          title: "Iluminación y Mejoras",
          description: "Instalación de luces LED, sistemas de automatización, calentadores solares y mejoras estéticas para tu piscina."
        }
      ]
    },
    contact: {
      ...
      subtitle: "Déjanos tus datos y te contactaremos en menos de 24 horas con una cotización personalizada.",
    ...
    configurator: {
      badge: "Configurador 3D",
      title: "Calcula tu limpieza de piscina",
      subtitle: "Ajusta dimensiones, elige el tipo de limpieza y revisa un valor estimado en tiempo real.",
      hint: "Usa el mouse o trackpad para orbitar, hacer zoom y mover la vista 3D.",
      shape: "Forma de piscina",
      ...
      width: "Ancho (m)",
      depth: "Profundidad (m)",
      estimateByRange: "Estimado según rango",
      area: "Área estimada",
      volume: "Volumen estimado",
      range: "Rango aplicado",
      estimateNote: "El valor es referencial y puede variar según estado de agua, acceso y equipos."
    },
    notFound: {
  ...
  en: {
    ...
    footer: {
      description: "Professional pool cleaning and maintenance service in Miami. Crystal-clear water, stress-free.",
    ...
    about: {
      badge: "About Us",
      title1: "Passion for",
      title2: "crystal-clear water",
      p1: "At BlueNova Pools, we provide professional pool care with a strong focus on quality, detail, and trust. Our certified experts make sure every pool shines with perfectly balanced and clean water.",
      p2: "We serve homes, condominiums, and commercial properties across Miami-Dade. Our mission is simple: help you enjoy your pool without worries.",
      cta: "Contact Us",
      values: "Our Values"
    },
    services: {
      badge: "Services",
      title: "Complete solutions for your pool",
      subtitle: "From routine cleaning to complex repairs, we cover all your pool care needs.",
      ctaTitle: "Not sure which service you need?",
      ctaText: "Contact us for free guidance. We assess your pool and recommend the best solution.",
      ctaButton: "Talk to an Expert",
      items: [
        {
          icon: "🧹",
          title: "Weekly Cleaning",
          description: "Our team visits weekly to vacuum, brush walls and tiles, clean skimmer baskets, and keep your water crystal clear."
        },
        {
          icon: "🧪",
          title: "Chemical Balancing",
          description: "We perform full water analysis: pH, chlorine, alkalinity, cyanuric acid, and more, then adjust to a safe perfect balance."
        },
        {
          icon: "🔧",
          title: "Equipment Repairs",
          description: "Specialized technical service for pumps, filters, heaters, salt systems, and automation. Fast diagnosis and repairs."
        },
        {
          icon: "🌿",
          title: "Algae Control",
          description: "Special treatment to prevent and remove green, black, or yellow algae and restore pool shine."
        },
        {
          icon: "🏊",
          title: "Opening and Closing",
          description: "We prepare your pool for the season or close it properly, including deep cleaning and equipment prep."
        },
        {
          icon: "💡",
          title: "Lighting and Upgrades",
          description: "LED lighting, automation systems, solar heaters, and aesthetic upgrades for your pool."
        }
      ]
    },
    contact: {
      badge: "Contact",
      title: "Free Quote",
      subtitle: "Leave your details and we will contact you within 24 hours with a personalized quote.",
      sentTitle: "Message sent!",
      sentText: "We will contact you shortly.",
      name: "Name",
      phone: "Phone",
      email: "Email",
    ...
    configurator: {
      ...
      title: "Estimate your pool cleaning",
      subtitle: "Adjust dimensions, choose cleaning type, and see a real-time estimate.",
      hint: "Use mouse or trackpad to orbit, zoom, and move the 3D view.",
      shape: "Pool shape",
      rectangular: "Rectangular",
      oval: "Oval",
      kidney: "Kidney",
      ...
      width: "Width (m)",
      depth: "Depth (m)",
      estimateByRange: "Estimate by range",
      area: "Estimated area",
      volume: "Estimated volume",
      range: "Applied range",
      estimateNote: "This value is indicative and may vary based on water condition, access, and equipment."
    },
    notFound: {
...
function I18nProvider({ children }) {
  const [locale, setLocaleState] = reactExports.useState(getInitialLocale);
  reactExports.useEffect(() => {
...
const brandLogo = "/assets/bluenova-mark-CUmk4ERU.png";
function Header() {
  const [mobileOpen, setMobileOpen] = reactExports.useState(false);
  const { t, locale, setLocale } = useI18n();
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "fixed top-0 left-0 right-0 z-50 bg-background/80 backdrop-blur-lg border-b border-border/50", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl flex items-center justify-between px-6 py-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/", className: "flex items-center gap-2", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xl font-bold text-foreground tracking-tight", children: "BlueNova Pools" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "hidden md:flex items-center gap-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/", className: "text-sm font-medium text-muted-foreground hover:text-foreground transition-colors", activeProps: { className: "text-sm font-medium text-primary" }, children: t.header.home }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/configurador", className: "text-sm font-medium text-muted-foreground hover:text-foreground transition-colors", activeProps: { className: "text-sm font-medium text-primary" }, children: t.header.configurator }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/services", className: "text-sm font-medium text-muted-foreground hover:text-foreground transition-colors", activeProps: { className: "text-sm font-medium text-primary" }, children: t.header.services }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/about", className: "text-sm font-medium text-muted-foreground hover:text-foreground transition-colors", activeProps: { className: "text-sm font-medium text-primary" }, children: t.header.about }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/contact", className: "text-sm font-medium text-muted-foreground hover:text-foreground transition-colors", activeProps: { className: "text-sm font-medium text-primary" }, children: t.header.contact })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "hidden md:flex items-center gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "inline-flex rounded-md border border-border bg-background p-1 text-xs", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              type: "button",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { asChild: true, variant: "default", size: "lg", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/contact", children: t.header.freeQuote }) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
    ...
    mobileOpen && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:hidden bg-background border-t border-border px-6 pb-6 pt-2 space-y-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/", className: "block py-2 text-sm font-medium text-foreground", onClick: () => setMobileOpen(false), children: t.header.home }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/configurador", className: "block py-2 text-sm font-medium text-foreground", onClick: () => setMobileOpen(false), children: t.header.configurator }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/services", className: "block py-2 text-sm font-medium text-foreground", onClick: () => setMobileOpen(false), children: t.header.services }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/about", className: "block py-2 text-sm font-medium text-foreground", onClick: () => setMobileOpen(false), children: t.header.about }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/contact", className: "block py-2 text-sm font-medium text-foreground", onClick: () => setMobileOpen(false), children: t.header.contact }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2 py-1", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            type: "button",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { asChild: true, variant: "default", className: "w-full", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/contact", onClick: () => setMobileOpen(false), children: t.header.freeQuote }) })
    ] })
  ] });
}
function Footer() {
  const { t } = useI18n();
  return /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "bg-foreground text-background", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-6 py-16", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-4 gap-10", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:col-span-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-4", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xl font-bold tracking-tight", children: "BlueNova Pools" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-background/60 text-sm max-w-sm leading-relaxed", children: t.footer.description })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-semibold mb-4 text-sm uppercase tracking-wider", children: t.footer.navigation }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/", className: "block text-sm text-background/60 hover:text-background transition-colors", children: t.header.home }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/configurador", className: "block text-sm text-background/60 hover:text-background transition-colors", children: t.header.configurator }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/services", className: "block text-sm text-background/60 hover:text-background transition-colors", children: t.header.services }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/about", className: "block text-sm text-background/60 hover:text-background transition-colors", children: t.header.about }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/contact", className: "block text-sm text-background/60 hover:text-background transition-colors", children: t.header.contact })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-semibold mb-4 text-sm uppercase tracking-wider", children: t.footer.contact }),
...
const appCss = "/assets/styles-CSw9EPFM.css";
function NotFoundComponent() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex min-h-screen items-center justify-center bg-background px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-md text-center", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 text-sm text-muted-foreground", children: t.notFound.description }),
...
const Route$5 = createRootRoute({
  head: () => {
    const seo = buildSeoMeta({
      title: "BlueNova Pools | Pool Cleaning and Maintenance in Miami",
      description: "BlueNova Pools provides pool cleaning, maintenance, and repair services in Miami. Fast response and free quotes.",
      path: "/"
    });
    return {
      meta: [
...
const $$splitComponentImporter$4 = () => import("./services-DvKb-qYx.js");
const Route$4 = createFileRoute("/services")({
  head: () => buildSeoMeta({
    title: "Pool Services in Miami — BlueNova Pools",
    description: "Explore BlueNova Pools services: weekly cleaning, chemical balancing, equipment repairs, algae control, and pool upgrades in Miami.",
    path: "/services"
  }),
  component: lazyRouteComponent($$splitComponentImporter$4, "component")
});
const $$splitComponentImporter$3 = () => import("./contact-C3Lc22F7.js");
const Route$3 = createFileRoute("/contact")({
  head: () => buildSeoMeta({
    title: "Contact BlueNova Pools — Free Quote in Miami",
    description: "Request your free pool service quote in Miami. Contact BlueNova Pools for cleaning, maintenance, repairs, and inspections.",
    path: "/contact"
  }),
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const $$splitComponentImporter$2 = () => import("./configurador-D1JRMujq.js").then((n) => n.a);
const Route$2 = createFileRoute("/configurador")({
  head: () => buildSeoMeta({
    title: "3D Pool Configurator — BlueNova Pools",
    description: "Use the BlueNova Pools 3D configurator to estimate weekly or one-time pool cleaning costs based on dimensions and shape.",
    path: "/configurador"
  }),
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const $$splitComponentImporter$1 = () => import("./about-C_mVwMwq.js");
const Route$1 = createFileRoute("/about")({
  head: () => buildSeoMeta({
    title: "About BlueNova Pools — Miami Pool Experts",
    description: "Learn about BlueNova Pools, a trusted Miami team focused on professional pool care, transparent service, and customer-first support.",
    path: "/about"
  }),
  component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
const $$splitComponentImporter = () => import("./index-D7OAgb0t.js");
const Route2 = createFileRoute("/")({
  head: () => buildSeoMeta({
    title: "BlueNova Pools — Pool Cleaning & Maintenance in Miami",
    description: "Professional pool cleaning, maintenance and repair in Miami. Certified technicians with fast response and free quotes in 24h.",
    path: "/"
  }),
...
const ConfiguradorRoute = Route$2.update({
  id: "/configurador",
  path: "/configurador",
  getParentRoute: () => Route$5
});
